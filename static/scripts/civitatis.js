...
!(function(a) {
  ...
  function l(a) {
    ...
    function E(a) {
      ...
      return (
        o(V),
        {x: Math.floor(Number(b.left) + Number(N.x)), y: Math.floor(Number(b.top) + Number(N.y))}
      );
    }
    function F(a) {
      function b() {
  ...
  function s(a) {
    ...
    function c(b) {
      I ||
        '0' !== a[b] ||
        ((I = !0), h(e, 'Hidden iFrame detected, creating visibility listener'), z());
    }
    function d(a) {
      b(a), c(a);
    }
  ...
  function w(c, d) {
    function e() {
      function a(a) {
        1 / 0 !== Q[x][a] &&
          0 !== Q[x][a] &&
          ((c.style[a] = Q[x][a] + 'px'), h(x, 'Set ' + a + ' = ' + Q[x][a] + 'px'));
      }
      function b(a) {
    ...
    function i() {
      switch (
        (h(
          x,
          'IFrame scrolling ' + (Q[x] && Q[x].scrolling ? 'enabled' : 'disabled') + ' for ' + x
        ),
